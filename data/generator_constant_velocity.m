...
mkdir(['constant_velocity_dataset/train']);
mkdir(['constant_velocity_dataset/valid']);

speeds = randi([5 30],1, 36);
...
for i = 1:K
    ...
    for j = 1 : file_size
        ...
        save(['constant_velocity_dataset/train/cons_Q' num2str(Q) '_k' num2str(i) '.mat'], ...
        ...
        save(['constant_velocity_dataset/valid/cons_Q' num2str(Q) '_k' num2str(i) '.mat'], ...
            'MM_data', 'beam_label', 'beam_power');
        i
end
